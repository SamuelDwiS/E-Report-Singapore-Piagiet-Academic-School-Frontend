          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm transition-colors">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <span className="bg-brand-100 dark:bg-brand-900/30 text-brand-700 dark:text-brand-400 px-3 py-1 rounded-full text-sm font-medium">Science A</span>
                <span className="bg-brand-100 dark:bg-brand-900/30 text-brand-700 dark:text-brand-400 px-3 py-1 rounded-full text-sm font-medium">Ind B</span>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm transition-colors">
              ...
              <div className="space-y-3">
                {[
                  { label: "Matematika", value: 88, color: "bg-brand-500" },
                  { label: "IPA", value: 82, color: "bg-success-400" },
                  { label: "Bahasa Indonesia", value: 79, color: "bg-warning-400" },
                ].map((item) => (
                  <div key={item.label}>
