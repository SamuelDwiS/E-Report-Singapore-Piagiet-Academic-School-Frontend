...
export default function StatisticGrade() {
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-white px-5 pb-5 pt-5 dark:border-gray-700 dark:bg-gray-800 sm:px-6 sm:pt-6 transition-colors">
